...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/dovi_tool-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dovi_tool-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add dovi_tool libdovi
# for installing globally
pixi global install dovi_tool libdovi
```
...
It is possible to list all of the versions of `dovi_tool` available on your platform:
...
```
pixi search dovi_tool --channel conda-forge
```
